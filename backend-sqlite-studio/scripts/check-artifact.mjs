...
const required = [
  ...
  [/BACKEND_SQLITE_STUDIO_PROBE/, "the non-mutating prerequisite probe"],
  [/\.openhands\/apps\/backend-sqlite-studio/, "the isolated App data path"],
  [/execute_bash_command/, "the controlled Agent Server command endpoint"],
  [/STRUCTURED WRAPPER/, "the structured SQL editor"],
  [/Delete exact directory/, "the destructive reset confirmation"],
  [/Agent handoff/, "the agent handoff page"],
  [/Browser preferences remain client-local/, "the persistence-boundary explanation"],
];
