...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function Ic(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return vc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : j || (n = t.type, e = t.pendingProps, r = Bd(_e.current).createElement(n), r[ht] = t, r[gt] = e, Pd(r, n, e), Ot(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
	...
	function Hc(e, t, n) {
		...
		switch (Bi(t), t.tag) {
			...
			case 27:
				if (k(t), n = _e.current, i = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Lc(t);
				else {
					if (!r) {
				...
				return B(t), null;
			case 5:
				if (k(t), i = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Lc(t);
				else {
					if (!r) {
						if (t.stateNode === null) throw Error(s(166));
						return B(t), null;
			...
			case 19:
				...
				return r.tail === null ? (B(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Pe(), e.sibling = null, n = N.current, O(N, i ? n & 1 | 2 : n & 1), j && Li(t, r.treeForkCount), e);
			case 22:
...
function se(e) {
	if (!oe(e)) throw Error("The Agent Server returned an unsafe home path.");
	return `${e.replace(/\/+$/, "")}/${h}`;
}
async function ce(e, t) {
	...
	if (!oe(r?.home)) throw Error("The Agent Server did not report a safe absolute home directory.");
	return r.home;
}
async function le(e, t, n, r, i) {
	if (!oe(t)) throw Error("The Agent Server home path failed validation.");
	ae(i);
...
async function T(e, t, n) {
	let r = ue(await le(e, t, te, 20, n), "CONVERSATION_SEARCH_PROBE"), i;
	try {
		i = JSON.parse(y(r));
	} catch {
...
function E(e) {
	let t = ue(e, "CONVERSATION_SEARCH"), n;
	try {
		n = JSON.parse(y(t));
	} catch {
...
async function fe(e, t, n) {
	E(await le(e, t, ne, 900, n));
}
async function pe(e, t, n) {
	await le(e, t, re, 30, n);
}
...
async function D(e, t, n) {
	...
	await fe(e, t, n), await me(e, t, n);
}
async function O(e, t, n) {
	await le(e, t, ie, 30, n);
}
async function he(e, t, n, r, i) {
	...
	return E(await le(e, t, de(n, r), o, i));
}
async function ge(e, t, n, r) {
	let i = await he(e, t, { action: "status" }, n, r);
	if (!i.status) throw Error("The native bridge omitted index status.");
	return i.status;
}
async function _e(e, t, n, r, i) {
	let a = await he(e, t, { action: n ? "rebuild" : "index" }, r, i);
...
function ke({ view: e, ready: t, running: n, navigate: r }) {
	return /* @__PURE__ */ (0, k.jsxs)("header", {
		...
		children: [
			...
			/* @__PURE__ */ (0, k.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, k.jsx)("span", {}), t ? n ? "Service active" : "Command mode" : "Setup needed"]
			})
		]
	});
}
function Ae({ location: e }) {
	return /* @__PURE__ */ (0, k.jsxs)("article", {
		...
		children: [
			/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("span", {
				...
				children: e.state
			}), /* @__PURE__ */ (0, k.jsx)("small", { children: e.layout })] }),
			/* @__PURE__ */ (0, k.jsx)("code", { children: e.path }),
			/* @__PURE__ */ (0, k.jsx)("p", { children: e.state === "ready" ? `${e.conversations.toLocaleString()} conversations · ${e.files.toLocaleString()} indexable files` : e.message ?? "No conversation data detected here." })
		]
	});
}
function je({ home: e, probe: t, busy: n, error: r, onInstall: i, onRecheck: a }) {
	let [o, s] = (0, l.useState)(!1), [c, u] = (0, l.useState)(!1), d = t.supported && t.goReady, f = async () => {
		await navigator.clipboard.writeText(be(e)), u(!0);
	};
		...
		children: [
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, k.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, k.jsx)("h1", { children: "Search years of agent work in milliseconds." }),
					/* @__PURE__ */ (0, k.jsx)("p", { children: "Conversation text stays on this Agent Server. The read-only probe below did not create a directory, compile code, or open a conversation file." })
				] }), /* @__PURE__ */ (0, k.jsxs)("div", {
					className: "css-orbit",
					"aria-hidden": "true",
					children: [
			...
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, k.jsxs)("article", { children: [
						...
						/* @__PURE__ */ (0, k.jsx)("h2", { children: t.target }),
						/* @__PURE__ */ (0, k.jsxs)("p", { children: [
							t.os,
							" · ",
							t.arch
						] }),
						/* @__PURE__ */ (0, k.jsx)("small", { children: "Supported: macOS and Linux on arm64/amd64." })
					] }),
					/* @__PURE__ */ (0, k.jsxs)("article", { children: [
						/* @__PURE__ */ (0, k.jsx)("span", {
						...
						/* @__PURE__ */ (0, k.jsx)("h2", { children: "Local Go build" }),
						/* @__PURE__ */ (0, k.jsx)("p", { children: t.goVersion ?? "Go 1.23+ was not found." }),
						/* @__PURE__ */ (0, k.jsx)("small", { children: "Go 1.23+ is required; no unverified prebuilt binary is executed." })
					] }),
					/* @__PURE__ */ (0, k.jsxs)("article", { children: [
						/* @__PURE__ */ (0, k.jsx)("span", {
							className: "neutral",
						...
						/* @__PURE__ */ (0, k.jsx)("h2", { children: "Durable local state" }),
						/* @__PURE__ */ (0, k.jsx)("code", { children: se(e) }),
						/* @__PURE__ */ (0, k.jsx)("small", { children: "Source, module/build cache, binary, index, logs, and run state live only here." })
					] })
				]
			}),
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, k.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, k.jsx)("h2", { children: "Candidate SDK stores" })] }), /* @__PURE__ */ (0, k.jsx)("button", {
					...
					children: t.locations.map((e) => /* @__PURE__ */ (0, k.jsx)(Ae, { location: e }, e.path))
				})]
			}),
			/* @__PURE__ */ (0, k.jsxs)("section", {
				className: "css-trust",
				children: [
					/* @__PURE__ */ (0, k.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, k.jsxs)("h2", { children: ["Build Conversation Search ", g] }),
						/* @__PURE__ */ (0, k.jsxs)("p", { children: [
							"The App writes its reviewed Go source, verifies SHA-256 ",
							/* @__PURE__ */ (0, k.jsxs)("code", { children: [_.slice(0, 16), "…"] }),
							", downloads the pinned Bleve module graph using the configured Go proxy, compiles locally for ",
							/* @__PURE__ */ (0, k.jsx)("strong", { children: t.target }),
							", records the binary SHA-256, and verifies the version and hash before every native execution."
						] }),
						/* @__PURE__ */ (0, k.jsxs)("p", {
							className: "css-privacy",
							children: [/* @__PURE__ */ (0, k.jsx)("strong", { children: "Sensitive local data:" }), " indexing creates a searchable copy of message text, selected command/output text, titles, timestamps, roles, and tool summaries. Hidden reasoning, system prompts, base state, and configured secrets are excluded. Nothing is uploaded by the App."]
						})
					] }),
...
function Me({ status: e }) {
	return /* @__PURE__ */ (0, k.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, k.jsxs)("article", { children: [
				/* @__PURE__ */ (0, k.jsx)("small", { children: "DOCUMENTS" }),
				/* @__PURE__ */ (0, k.jsx)("strong", { children: e.documents.toLocaleString() }),
				/* @__PURE__ */ (0, k.jsxs)("span", { children: [e.sourceFiles.toLocaleString(), " source files"] })
			] }),
			/* @__PURE__ */ (0, k.jsxs)("article", { children: [
				/* @__PURE__ */ (0, k.jsx)("small", { children: "CONVERSATIONS" }),
				/* @__PURE__ */ (0, k.jsx)("strong", { children: e.conversations.toLocaleString() }),
				/* @__PURE__ */ (0, k.jsxs)("span", { children: [e.malformedFiles, " malformed skipped"] })
			] }),
			/* @__PURE__ */ (0, k.jsxs)("article", { children: [
				/* @__PURE__ */ (0, k.jsx)("small", { children: "INDEX SIZE" }),
				/* @__PURE__ */ (0, k.jsx)("strong", { children: De(e.indexBytes) }),
				/* @__PURE__ */ (0, k.jsx)("span", { children: e.lastIndexedAt ? `Updated ${new Date(e.lastIndexedAt).toLocaleString()}` : "Not indexed yet" })
			] }),
			/* @__PURE__ */ (0, k.jsxs)("article", { children: [
				/* @__PURE__ */ (0, k.jsx)("small", { children: "EXECUTION" }),
				/* @__PURE__ */ (0, k.jsx)("strong", { children: e.service.running ? "Service" : "Command" }),
				/* @__PURE__ */ (0, k.jsx)("span", { children: e.service.running ? `Idle stop in ${Math.max(0, 600 - (e.service.idleSeconds ?? 0))}s` : "One-shot CLI bridge" })
			] })
		]
	});
}
function Ne({ hit: e, close: t }) {
	return /* @__PURE__ */ (0, k.jsxs)("aside", {
		...
		children: [
			...
			/* @__PURE__ */ (0, k.jsx)("h2", { children: e.title || "Untitled conversation" }),
			/* @__PURE__ */ (0, k.jsxs)("dl", { children: [
				/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("dt", { children: "Conversation" }), /* @__PURE__ */ (0, k.jsx)("dd", { children: e.conversationId })] }),
				/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("dt", { children: "Event" }), /* @__PURE__ */ (0, k.jsx)("dd", { children: e.eventId })] }),
				/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("dt", { children: "Kind / role" }), /* @__PURE__ */ (0, k.jsxs)("dd", { children: [
					e.kind,
					" · ",
					e.role
				] })] }),
				/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("dt", { children: "Tool" }), /* @__PURE__ */ (0, k.jsx)("dd", { children: e.tool || "—" })] }),
				/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("dt", { children: "Timestamp" }), /* @__PURE__ */ (0, k.jsx)("dd", { children: e.timestamp || "—" })] }),
				/* @__PURE__ */ (0, k.jsxs)("div", { children: [/* @__PURE__ */ (0, k.jsx)("dt", { children: "Source" }), /* @__PURE__ */ (0, k.jsx)("dd", { children: /* @__PURE__ */ (0, k.jsx)("code", { children: e.sourcePath }) })] })
			] }),
			/* @__PURE__ */ (0, k.jsx)("h3", { children: "Indexed text" }),
			/* @__PURE__ */ (0, k.jsx)("pre", { children: e.text || e.summary || "This record contains metadata only." }),
			/* @__PURE__ */ (0, k.jsx)("p", {
				className: "css-muted",
...
function Pe({ host: e, home: t, status: n, setStatus: r, signal: i }) {
			...
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, k.jsxs)("div", {
						...
						}), /* @__PURE__ */ (0, k.jsx)("h1", { children: "Find the moment, not the folder." })] }), /* @__PURE__ */ (0, k.jsx)("span", {
							className: "css-mode",
					...
					/* @__PURE__ */ (0, k.jsxs)("form", {
						...
						children: [/* @__PURE__ */ (0, k.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, k.jsxs)("label", { children: ["Role", /* @__PURE__ */ (0, k.jsxs)("select", {
								...
								/* @__PURE__ */ (0, k.jsxs)("label", { children: ["Kind", /* @__PURE__ */ (0, k.jsx)("input", {
								...
								/* @__PURE__ */ (0, k.jsxs)("label", { children: ["Tool", /* @__PURE__ */ (0, k.jsx)("input", {
								...
								/* @__PURE__ */ (0, k.jsxs)("label", { children: ["After", /* @__PURE__ */ (0, k.jsx)("input", {
								...
								/* @__PURE__ */ (0, k.jsxs)("label", { children: ["Before", /* @__PURE__ */ (0, k.jsx)("input", {
			...
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, k.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, k.jsx)("strong", { children: u ? `${u.total.toLocaleString()} matches` : "Ready to search" }), u ? /* @__PURE__ */ (0, k.jsxs)("span", { children: [
							u.durationMs.toFixed(1),
							" ms · top ",
							u.hits.length
						] }) : /* @__PURE__ */ (0, k.jsx)("span", { children: "Run Index now from operations if this is your first visit." })]
					}),
					u?.hits.map((e) => /* @__PURE__ */ (0, k.jsxs)("button", {
						type: "button",
						className: "css-hit",
						onClick: () => void b(e.id),
						children: [
							/* @__PURE__ */ (0, k.jsxs)("div", { children: [
								/* @__PURE__ */ (0, k.jsx)("span", {
									className: "css-role",
									children: e.role || "unknown"
								}),
								/* @__PURE__ */ (0, k.jsx)("span", { children: e.kind }),
								e.tool ? /* @__PURE__ */ (0, k.jsx)("span", { children: e.tool }) : null,
								/* @__PURE__ */ (0, k.jsx)("time", { children: e.timestamp ? new Date(e.timestamp).toLocaleString() : "No timestamp" })
							] }),
							/* @__PURE__ */ (0, k.jsx)("h2", { children: e.title || e.conversationId }),
							/* @__PURE__ */ (0, k.jsx)("p", { children: Oe(e.excerpt) || "Metadata-only indexed record" }),
							/* @__PURE__ */ (0, k.jsx)("code", { children: e.sourcePath })
						]
					}, e.id)),
					u && u.hits.length === 0 ? /* @__PURE__ */ (0, k.jsxs)("div", {
						className: "css-empty",
						children: [
							/* @__PURE__ */ (0, k.jsx)("span", { children: "⌕" }),
							/* @__PURE__ */ (0, k.jsx)("h2", { children: "No indexed events matched." }),
							/* @__PURE__ */ (0, k.jsx)("p", { children: "Try fewer filters, a broader phrase, or refresh the index." })
						]
					}) : null
				]
			}),
			f ? /* @__PURE__ */ (0, k.jsx)(Ne, {
				hit: f,
				close: () => p(null)
			}) : null
		]
...
function Fe({ host: e, home: t, status: n, setStatus: r, recheck: i, signal: a }) {
	...
	}, _ = () => g("Recheck", async () => r(await ge(e, t, n.service.running ? "rpc" : "once", a))), v = (n) => {
		(!n || window.confirm("Rebuild deletes only the App-owned Bleve index and source manifest, then recreates them from read-only conversation data. Continue?")) && g(n ? "Full rebuild" : "Incremental index", async () => r(await _e(e, t, n, h, a)));
	}, y = () => void g(n.service.running ? "Stop service" : "Start service", async () => {
		n.service.running ? await me(e, t, a) : await pe(e, t, a), r(await ge(e, t, "once", a));
	}), b = () => {
		...
		children: [
			...
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, k.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, k.jsx)("h1", { children: "Own the index lifecycle." }),
					/* @__PURE__ */ (0, k.jsxs)("p", { children: [
						"Conversation sources are always read-only. Every mutation stays below ",
						/* @__PURE__ */ (0, k.jsx)("code", { children: se(t) }),
						"."
					] })
				] }), /* @__PURE__ */ (0, k.jsx)("button", {
					className: "css-button",
			...
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, k.jsxs)("article", { children: [
						...
						/* @__PURE__ */ (0, k.jsx)("h2", { children: "Index content" }),
						/* @__PURE__ */ (0, k.jsx)("p", { children: "Incremental updates compare source path, size, nanosecond mtime, and SHA-256 fallback. Changed records are upserted and deleted sources are removed." }),
						/* @__PURE__ */ (0, k.jsxs)("div", {
							className: "css-actions",
							children: [/* @__PURE__ */ (0, k.jsx)("button", {
								className: "css-button primary",
						...
						n.added || n.updated || n.removed || n.skipped ? /* @__PURE__ */ (0, k.jsxs)("small", { children: [
							"Last run: ",
							n.added ?? 0,
							" added · ",
							n.updated ?? 0,
					...
					/* @__PURE__ */ (0, k.jsxs)("article", { children: [
						...
						/* @__PURE__ */ (0, k.jsx)("h2", { children: "Native service" }),
						/* @__PURE__ */ (0, k.jsx)("p", { children: "The browser never calls localhost. Bash invokes the verified companion CLI, which reads an App-private token/port state file and performs JSON RPC." }),
						/* @__PURE__ */ (0, k.jsx)("div", {
							className: "css-actions",
							children: /* @__PURE__ */ (0, k.jsx)("button", {
								className: "css-button primary",
					...
					/* @__PURE__ */ (0, k.jsxs)("article", { children: [
						...
						/* @__PURE__ */ (0, k.jsx)("h2", { children: "Recover safely" }),
						/* @__PURE__ */ (0, k.jsx)("p", { children: "Repair runtime recompiles from verified source and preserves the index. Full rebuild repairs an unreadable index from unchanged source data." }),
						/* @__PURE__ */ (0, k.jsx)("button", {
							className: "css-button",
							onClick: b,
							disabled: !!o,
			...
			/* @__PURE__ */ (0, k.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, k.jsx)("div", {
					...
					}), /* @__PURE__ */ (0, k.jsx)("h2", { children: "Validated locations" })] })
				}), /* @__PURE__ */ (0, k.jsx)("div", {
					className: "css-locations",
					children: n.locations.map((e) => /* @__PURE__ */ (0, k.jsx)(Ae, { location: e }, e.path))
				})]
			}),
			/* @__PURE__ */ (0, k.jsxs)("section", {
				className: "css-danger",
				children: [/* @__PURE__ */ (0, k.jsxs)("div", { children: [
					/* @__PURE__ */ (0, k.jsx)("h2", { children: "Uninstall App-owned data" }),
					/* @__PURE__ */ (0, k.jsx)("p", { children: "Stop the service and permanently delete the binary, local source/build cache, Bleve index, manifests, logs, and run state. Conversation sources and sibling Apps are untouched." }),
					/* @__PURE__ */ (0, k.jsx)("code", { children: se(t) })
