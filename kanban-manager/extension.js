...
without parsing prose.
    ...
    vibectl.py dispatch --prompt-file task.md --title "\u{1F3AB} Fix login" --profile opus
...
var Live = class {
  ...
  llmModel(convId, sticky = false) {
    ...
    if (!this.inFlight.has(key)) {
      ...
      }).catch(() => this.models.set(convId, this.models.peek(convId) ?? null)).finally(() => this.inFlight.delete(key));
    }
