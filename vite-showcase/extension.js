...
var e = Object.defineProperty, t = (e, t, n) => () => {
	...
	function xi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") vi(e) && (s = 1);
			...
			case w: return e = _i(13, n, t, a), e.elementType = w, e.lanes = o, e;
...
}, g = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2064%2064'%20role='img'%20aria-label='Vite%20Showcase%20mark'%3e%3cdefs%3e%3clinearGradient%20id='a'%20x1='8'%20y1='4'%20x2='52'%20y2='60'%20gradientUnits='userSpaceOnUse'%3e%3cstop%20stop-color='%239B87F5'/%3e%3cstop%20offset='.52'%20stop-color='%2368D5F2'/%3e%3cstop%20offset='1'%20stop-color='%23F9C86B'/%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill='url(%23a)'%20d='M32%203%2058%2018v28L32%2061%206%2046V18L32%203Z'/%3e%3cpath%20fill='%23101321'%20fill-rule='evenodd'%20d='m19%2020%2013%2030%2013-30-8%204-5-10-5%2010-8-4Zm10.7%208.1L32%2023l2.3%205.1%203.2-1.6L32%2039l-5.5-12.5%203.2%201.6Z'%20clip-rule='evenodd'/%3e%3c/svg%3e", _ = "(function(){function e(e){let t=0,n=1;for(let r=0;r<e;r+=1)[t,n]=[n,t+n];return t}self.addEventListener(`message`,t=>{let n=performance.now(),r=t.data.input;self.postMessage({input:r,value:e(r),durationMs:Number((performance.now()-n).toFixed(2))})})})();", v = typeof self < "u" && self.Blob && new Blob(["(self.URL || self.webkitURL).revokeObjectURL(self.location.href);", _], { type: "text/javascript;charset=utf-8" });
function y(e) {
	let t;
	try {
...
var b = /* @__PURE__ */ n(((e) => {
	...
	t.exports = b();
})), ee = /* @__PURE__ */ r({ loadBuildInsight: () => S });
async function S(e) {
	return await new Promise((t, n) => {
		let r = window.setTimeout(t, 40);
		e.addEventListener("abort", () => {
			window.clearTimeout(r), n(new DOMException("The insight was cancelled.", "AbortError"));
		}, { once: !0 });
	}), "The lazy module resolved inside the same artifact—no network chunk was requested.";
}
var C = t((() => {})), w = x(), te = "/extensions/vite-showcase/showcase", ne = [
	"overview",
	"architecture",
	"diagnostics"
];
function T(e) {
	...
	return t === "" || t === "overview" ? "overview" : ne.includes(t) ? t : "not-found";
}
function re({ route: e, go: t }) {
	return /* @__PURE__ */ (0, w.jsx)("nav", {
		className: "vs-nav",
		"aria-label": "Showcase pages",
		children: ne.map((n) => /* @__PURE__ */ (0, w.jsx)("button", {
			type: "button",
			"aria-current": e === n ? "page" : void 0,
			onClick: () => t(n),
			children: n[0].toUpperCase() + n.slice(1)
		}, n))
	});
}
function ie({ go: e }) {
	return /* @__PURE__ */ (0, w.jsxs)("main", { children: [/* @__PURE__ */ (0, w.jsxs)("section", {
		className: "vs-hero",
		children: [/* @__PURE__ */ (0, w.jsxs)("div", { children: [
			/* @__PURE__ */ (0, w.jsx)("p", {
				className: "vs-eyebrow",
				children: "One installable artifact"
			}),
			...
			/* @__PURE__ */ (0, w.jsxs)("p", {
				...
				children: [
					"A conventional ",
					h.framework,
					" App—TypeScript, modular CSS, assets, lazy code, and background work—compressed into one authenticated Canvas bundle."
				]
			}),
			/* @__PURE__ */ (0, w.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, w.jsx)("button", {
					...
					type: "button",
					onClick: () => e("architecture"),
					children: "See the bundle map"
				}), /* @__PURE__ */ (0, w.jsx)("button", {
					className: "vs-cta",
					type: "button",
					onClick: () => e("diagnostics"),
					children: "Inspect runtime"
				})]
			})
		] }), /* @__PURE__ */ (0, w.jsxs)("div", {
			className: "vs-orbit",
			"aria-label": "Bundled technologies",
			children: [
		...
		children: [
			/* @__PURE__ */ (0, w.jsx)("p", {
				className: "vs-eyebrow",
				children: "Included in extension.js"
			}),
			/* @__PURE__ */ (0, w.jsx)("h2", {
				id: "inventory-title",
				className: "vs-page-title",
				children: "A full toolchain, folded flat."
			}),
			/* @__PURE__ */ (0, w.jsx)("p", {
				className: "vs-section-lede",
				children: "Every card below began as a separate source concern. None requires a sibling file at runtime."
			}),
			/* @__PURE__ */ (0, w.jsx)("div", {
				className: "vs-grid",
				children: h.features.map((e, t) => /* @__PURE__ */ (0, w.jsxs)("article", {
					className: "vs-card",
					children: [
						/* @__PURE__ */ (0, w.jsxs)("p", {
							className: "vs-card-label",
							children: ["Layer ", String(t + 1).padStart(2, "0")]
						}),
						/* @__PURE__ */ (0, w.jsx)("h3", { children: e }),
						/* @__PURE__ */ (0, w.jsx)("p", { children: t < 3 ? "Loaded through Vite's asset pipeline." : "Bundled as executable module code." })
					]
				}, e))
			})
		]
...
function ae({ insight: e }) {
	return /* @__PURE__ */ (0, w.jsxs)("main", {
		className: "vs-section",
		children: [
			/* @__PURE__ */ (0, w.jsx)("p", {
				className: "vs-eyebrow",
				children: "Build anatomy"
			}),
			/* @__PURE__ */ (0, w.jsx)("h1", {
				className: "vs-page-title",
				children: "Many inputs. One output."
			}),
			/* @__PURE__ */ (0, w.jsx)("p", {
				className: "vs-section-lede",
				children: "Vite keeps authoring pleasant, then deliberately removes runtime resolution from the equation."
			}),
			/* @__PURE__ */ (0, w.jsxs)("div", {
				className: "vs-architecture",
				children: [
					/* @__PURE__ */ (0, w.jsxs)("article", {
						className: "vs-card",
						children: [/* @__PURE__ */ (0, w.jsx)("p", {
							className: "vs-card-label",
							children: "Source graph"
						}), /* @__PURE__ */ (0, w.jsx)("div", {
							className: "vs-stack",
							children: [
								"extension.tsx",
								...
								"lazy-insight.ts",
								"diagnostics.worker.ts"
							].map((e) => /* @__PURE__ */ (0, w.jsxs)("code", { children: ["src/", e] }, e))
						})]
					}),
					/* @__PURE__ */ (0, w.jsxs)("article", {
						className: "vs-card",
						children: [/* @__PURE__ */ (0, w.jsx)("p", {
							...
							children: [
								/* @__PURE__ */ (0, w.jsx)("div", {
									className: "vs-flow-step",
									children: /* @__PURE__ */ (0, w.jsxs)("div", { children: [/* @__PURE__ */ (0, w.jsx)("h3", { children: "Transform" }), /* @__PURE__ */ (0, w.jsx)("p", { children: "JSX, TypeScript, CSS, Markdown, JSON, SVG, and Worker source enter Vite." })] })
								}),
								/* @__PURE__ */ (0, w.jsx)("div", {
									className: "vs-flow-step",
									children: /* @__PURE__ */ (0, w.jsxs)("div", { children: [/* @__PURE__ */ (0, w.jsx)("h3", { children: "Inline" }), /* @__PURE__ */ (0, w.jsx)("p", { children: "Dynamic modules and assets become part of the ESM artifact." })] })
								}),
								/* @__PURE__ */ (0, w.jsx)("div", {
									className: "vs-flow-step",
									children: /* @__PURE__ */ (0, w.jsxs)("div", { children: [/* @__PURE__ */ (0, w.jsx)("h3", { children: "Validate" }), /* @__PURE__ */ (0, w.jsx)("p", { children: "The artifact check rejects chunks, bare imports, and relative runtime assets." })] })
								}),
								/* @__PURE__ */ (0, w.jsx)("div", {
									className: "vs-flow-step",
									children: /* @__PURE__ */ (0, w.jsxs)("div", { children: [/* @__PURE__ */ (0, w.jsx)("h3", { children: "Activate" }), /* @__PURE__ */ (0, w.jsxs)("p", { children: [
										"Canvas imports ",
										/* @__PURE__ */ (0, w.jsx)("code", { children: "extension.js" }),
										" from a Blob URL."
									] })] })
								})
							]
					...
					/* @__PURE__ */ (0, w.jsxs)("article", {
						...
						children: [
							/* @__PURE__ */ (0, w.jsx)("p", {
								className: "vs-card-label",
								children: "Source-level dynamic import"
							}),
							/* @__PURE__ */ (0, w.jsx)("h3", { children: e || "Loading the lazy module…" }),
							/* @__PURE__ */ (0, w.jsxs)("p", { children: [/* @__PURE__ */ (0, w.jsx)("code", { children: "import(\"./lazy-insight\")" }), " remains modular in source and local in production."] })
						]
					})
				]
			})
...
function oe({ label: e, children: t }) {
...
function se({ host: e, path: t, workerResult: n }) {
	let r = e.backend ?? {}, i = e.extension ?? {
		name: "vite-showcase",
		version: "unknown"
	};
	return /* @__PURE__ */ (0, w.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, w.jsx)("p", {
				className: "vs-section-lede",
				children: "Values below come from the authenticated host and this App's inline Worker."
			}),
			/* @__PURE__ */ (0, w.jsxs)("div", {
				className: "vs-diagnostics",
				children: [
					/* @__PURE__ */ (0, w.jsx)(oe, {
						label: "Host API",
						children: /* @__PURE__ */ (0, w.jsxs)("span", {
							className: "vs-status",
							children: ["Version ", e.apiVersion]
						})
					}),
					...
					/* @__PURE__ */ (0, w.jsx)(oe, {
						label: "Worker result",
						children: n ? `fibonacci(${n.input}) = ${n.value} · ${n.durationMs}ms` : "Calculating off the main thread…"
					}),
					/* @__PURE__ */ (0, w.jsx)(oe, {
						label: "Artifact contract",
						children: "one ESM file · Blob-safe · self-contained"
					})
				]
			})
		]
...
function ce({ go: e }) {
	return /* @__PURE__ */ (0, w.jsx)("main", {
		className: "vs-not-found",
		children: /* @__PURE__ */ (0, w.jsxs)("div", { children: [
			/* @__PURE__ */ (0, w.jsx)("strong", { children: "404" }),
			/* @__PURE__ */ (0, w.jsx)("h1", { children: "That nested route is not in this bundle." }),
			/* @__PURE__ */ (0, w.jsx)("button", {
				className: "vs-cta vs-cta--primary",
				type: "button",
				onClick: () => e("overview"),
				children: "Return to showcase root"
			})
		] })
	});
}
function le({ host: e, path: t, navigate: n, signal: r }) {
	let i = T(t), [a, o] = (0, f.useState)(null), [s, c] = (0, f.useState)(""), l = (e) => n(e === "overview" ? te : `${te}/${e}`);
	return (0, f.useEffect)(() => {
		let e = new y(), t = (e) => o(e.data);
		e.addEventListener("message", t), e.postMessage({ input: 32 });
		let n = (e) => {
			e.altKey && e.key >= "1" && e.key <= "3" && l(ne[Number(e.key) - 1]);
		};
		return window.addEventListener("keydown", n), Promise.resolve().then(() => (C(), ee)).then(({ loadBuildInsight: e }) => e(r)).then(c).catch((e) => {
			if (!(e instanceof DOMException && e.name === "AbortError")) throw e;
		}), () => {
			e.removeEventListener("message", t), e.terminate(), window.removeEventListener("keydown", n);
		};
	}, [r]), /* @__PURE__ */ (0, w.jsx)("section", {
		className: "vite-showcase",
		"aria-label": "Vite Showcase App",
			...
			children: [
				/* @__PURE__ */ (0, w.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, w.jsxs)("button", {
						...
						type: "button",
						onClick: () => l("overview"),
						"aria-label": "Return to Vite Showcase root",
						children: [/* @__PURE__ */ (0, w.jsx)("img", {
							className: "vs-mark",
							src: g,
							alt: ""
						}), /* @__PURE__ */ (0, w.jsxs)("span", {
							className: "vs-brand-copy",
							children: [/* @__PURE__ */ (0, w.jsx)("span", {
								className: "vs-kicker",
								children: "Canvas App"
							}), /* @__PURE__ */ (0, w.jsx)("span", {
								className: "vs-brand-name",
								children: "Vite Showcase"
							})]
						})]
					}), /* @__PURE__ */ (0, w.jsx)(re, {
						route: i,
				...
				i === "overview" ? /* @__PURE__ */ (0, w.jsx)(ie, { go: l }) : null,
				i === "architecture" ? /* @__PURE__ */ (0, w.jsx)(ae, { insight: s }) : null,
				i === "diagnostics" ? /* @__PURE__ */ (0, w.jsx)(se, {
					host: e,
					path: t,
					workerResult: a
				}) : null,
				i === "not-found" ? /* @__PURE__ */ (0, w.jsx)(ce, { go: l }) : null,
				/* @__PURE__ */ (0, w.jsxs)("footer", {
					...
					children: [/* @__PURE__ */ (0, w.jsxs)("span", { children: [
						...
						" · ",
						h.language
					] }), /* @__PURE__ */ (0, w.jsx)("span", { children: "Alt+1 / 2 / 3 to navigate" })]
				})
			]
		})
	});
...
var E = ".vite-showcase{--vs-bg:var(--oh-background,#090b12);--vs-panel:var(--oh-surface,#121624);--vs-panel-raised:var(--oh-surface-raised,#1a2031);--vs-text:var(--oh-foreground,#f7f8fc);--vs-muted:var(--oh-text-secondary,#a5adc0);--vs-border:color-mix(in srgb, var(--vs-text) 14%, transparent);--vs-purple:#9b87f5;--vs-blue:#68d5f2;--vs-gold:#f9c86b;min-height:100%;color:var(--vs-text);background:radial-gradient(circle at 10% -5%, color-mix(in srgb, var(--vs-purple) 18%, transparent), transparent 32rem), radial-gradient(circle at 95% 18%, color-mix(in srgb, var(--vs-blue) 10%, transparent), transparent 28rem), var(--vs-bg);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;line-height:1.5}.vite-showcase *,.vite-showcase :before,.vite-showcase :after{box-sizing:border-box}.vs-shell{width:min(1120px,100%);margin:0 auto;padding:clamp(1rem,3vw,2.25rem)}.vs-header{justify-content:space-between;align-items:center;gap:1.25rem;margin-bottom:2.5rem;display:flex}.vs-brand{color:inherit;cursor:pointer;text-align:left;background:0 0;border:0;align-items:center;gap:.75rem;padding:0;display:flex}.vs-brand:focus-visible,.vs-nav button:focus-visible,.vs-cta:focus-visible{outline:2px solid var(--vs-blue);outline-offset:3px}.vs-mark{filter:drop-shadow(0 8px 18px #68d5f22e);width:2.6rem;height:2.6rem}.vs-brand-copy{display:grid}.vs-kicker{color:var(--vs-blue);letter-spacing:.15em;text-transform:uppercase;font-size:.66rem;font-weight:800}.vs-brand-name{letter-spacing:-.01em;font-size:.95rem;font-weight:720}.vs-nav{border:1px solid var(--vs-border);background:color-mix(in srgb, var(--vs-panel) 84%, transparent);border-radius:.85rem;gap:.3rem;padding:.28rem;display:flex}.vs-nav button{color:var(--vs-muted);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:.58rem;padding:.5rem .72rem;font-size:.76rem;font-weight:680}.vs-nav button:hover{color:var(--vs-text)}.vs-nav button[aria-current=page]{color:var(--vs-text);background:var(--vs-panel-raised);box-shadow:0 1px 8px #0003}.vs-hero{grid-template-columns:1.35fr .85fr;align-items:center;gap:clamp(1.5rem,5vw,4rem);min-height:28rem;display:grid}.vs-eyebrow{color:var(--vs-gold);letter-spacing:.12em;text-transform:uppercase;align-items:center;gap:.5rem;margin:0 0 1rem;font-size:.72rem;font-weight:760;display:inline-flex}.vs-eyebrow:before{content:\"\";background:currentColor;width:1.5rem;height:1px}.vs-hero h1,.vs-page-title{letter-spacing:-.065em;max-width:780px;margin:0;font-size:clamp(2.6rem,7vw,5.8rem);line-height:.95}.vs-gradient{color:#0000;background:linear-gradient(100deg, var(--vs-purple), var(--vs-blue) 55%, var(--vs-gold));-webkit-background-clip:text;background-clip:text}.vs-lede{max-width:620px;color:var(--vs-muted);margin:1.5rem 0 0;font-size:clamp(.98rem,2vw,1.15rem)}.vs-actions{flex-wrap:wrap;gap:.7rem;margin-top:1.7rem;display:flex}.vs-cta{border:1px solid var(--vs-border);color:var(--vs-text);background:var(--vs-panel);font:inherit;cursor:pointer;border-radius:.7rem;padding:.68rem .9rem;font-size:.8rem;font-weight:720}.vs-cta--primary{color:#101321;background:linear-gradient(110deg, var(--vs-blue), #b7ebf8);border-color:#0000}.vs-orbit{aspect-ratio:1;place-items:center;display:grid;position:relative}.vs-orbit:before,.vs-orbit:after{content:\"\";border:1px solid var(--vs-border);border-radius:50%;position:absolute;inset:8%}.vs-orbit:after{border-style:dashed;animation:24s linear infinite vs-spin;inset:23%}.vs-orbit img{z-index:1;width:36%}.vs-pill{z-index:2;border:1px solid var(--vs-border);color:var(--vs-muted);background:var(--vs-panel);border-radius:999px;padding:.34rem .58rem;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.66rem;position:absolute}.vs-pill:first-of-type{top:12%;left:2%}.vs-pill:nth-of-type(2){top:24%;right:-2%}.vs-pill:nth-of-type(3){bottom:16%;left:3%}.vs-pill:nth-of-type(4){bottom:7%;right:5%}.vs-section{padding:2rem 0}.vs-page-title{font-size:clamp(2.2rem,6vw,4.4rem)}.vs-section-lede{max-width:720px;color:var(--vs-muted);margin:1.2rem 0 2rem}.vs-grid{grid-template-columns:repeat(3,1fr);gap:.9rem;display:grid}.vs-card{border:1px solid var(--vs-border);background:color-mix(in srgb, var(--vs-panel) 91%, transparent);border-radius:1rem;min-width:0;padding:1.15rem}.vs-card-label{color:var(--vs-blue);letter-spacing:.12em;text-transform:uppercase;margin:0 0 .5rem;font-size:.65rem;font-weight:780}.vs-card h2,.vs-card h3{letter-spacing:-.02em;margin:0;font-size:1rem}.vs-card p{color:var(--vs-muted);margin:.55rem 0 0;font-size:.82rem}.vs-card code{color:var(--vs-gold);overflow-wrap:anywhere;font-size:.77rem}.vs-stack{gap:.9rem;display:grid}.vs-architecture{grid-template-columns:1fr 1fr;gap:1rem;display:grid}.vs-flow{counter-reset:flow;gap:.7rem;display:grid}.vs-flow-step{grid-template-columns:2.1rem 1fr;align-items:start;gap:.7rem;display:grid}.vs-flow-step:before{counter-increment:flow;content:counter(flow, decimal-leading-zero);color:var(--vs-purple);font:700 .72rem/1.8 ui-monospace,monospace}.vs-raw{white-space:pre-wrap;color:var(--vs-muted);margin:0;font-size:.83rem}.vs-diagnostics{grid-template-columns:repeat(2,minmax(0,1fr));gap:.9rem;display:grid}.vs-value{overflow-wrap:anywhere;margin-top:.45rem;font:680 .9rem/1.45 ui-monospace,SFMono-Regular,Menlo,monospace}.vs-status{color:#75e3a1;align-items:center;gap:.45rem;display:inline-flex}.vs-status:before{content:\"\";background:currentColor;border-radius:50%;width:.48rem;height:.48rem;box-shadow:0 0 12px}.vs-footer{border-top:1px solid var(--vs-border);color:var(--vs-muted);justify-content:space-between;gap:1rem;margin-top:3rem;padding-top:1.2rem;font-size:.7rem;display:flex}.vs-not-found{text-align:center;place-items:center;min-height:25rem;display:grid}.vs-not-found strong{color:var(--vs-panel-raised);font-size:clamp(3rem,12vw,8rem);line-height:1;display:block}@keyframes vs-spin{to{transform:rotate(360deg)}}@media (width<=780px){.vs-header{flex-direction:column;align-items:flex-start;margin-bottom:1.5rem}.vs-nav{width:100%;overflow-x:auto}.vs-hero{grid-template-columns:1fr;min-height:auto}.vs-orbit{width:min(24rem,90%);margin:0 auto}.vs-grid{grid-template-columns:1fr 1fr}.vs-architecture{grid-template-columns:1fr}}@media (width<=520px){.vs-grid,.vs-diagnostics{grid-template-columns:1fr}.vs-nav button{flex:1}.vs-footer{flex-direction:column}}@media (prefers-reduced-motion:reduce){.vs-orbit:after{animation:none}}", D = "showcase";
function ue(e) {
	if (e.apiVersion !== "1") throw Error(`Vite Showcase requires Canvas host API 1, received ${e.apiVersion}.`);
	return e.registerPage(D, ({ container: t, path: n, navigate: r }) => {
		let i = new AbortController(), a = document.createElement("style");
		a.dataset.viteShowcase = "styles", a.textContent = E;
		let o = document.createElement("div");
		o.dataset.viteShowcase = "root", t.append(a, o);
		let s = (0, p.createRoot)(o);
		return s.render(/* @__PURE__ */ (0, w.jsx)(le, {
			host: e,
			path: n,
			navigate: r,
			signal: i.signal
...
var de = { PAGE_ID: D };
//#endregion
export { de as __testing, ue as activate };
