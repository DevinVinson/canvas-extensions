...
const required = [
  ...
  [/data:application\/wasm;base64,/, "embedded SQLite WASM"],
  [/indexedDB/, "IndexedDB persistence"],
  [/001-create-library/, "the imported SQL migration"],
  [/The Left Hand of Darkness/, "the imported JSON seed data"],
];
...
console.log(`Artifact OK: one self-contained ESM file (${info.size.toLocaleString()} bytes) with inline Worker, WASM, migration, and seed data.`);
